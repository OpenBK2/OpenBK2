...
using namespace NDb;
REGISTER_DATABASE_CLASS( SOUND, 0x111814C0, SPlayTime )
REGISTER_DATABASE_CLASS( SOUND, 0x11181300, SFade )
REGISTER_DATABASE_CLASS( SOUND, 0x11181301, SMusicTrack )
REGISTER_DATABASE_CLASS( SOUND, 0x11181302, SComposition )
