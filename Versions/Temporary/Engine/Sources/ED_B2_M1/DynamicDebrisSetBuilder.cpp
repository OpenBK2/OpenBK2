...
const std::string CDynamicDebrisSetBuilder::BUILD_DATA_TYPE_NAME = "DynamicDebrisSetBuilder";


bool CDynamicDebrisSetBuilder::IsValidBuildData( IManipulator *pBuildDataManipulator, std::string *pszDescription, IView *pBuildDataView )
{
...
bool CDynamicDebrisSetBuilder::InternalInsertObject( std::string *pszObjectTypeName,
