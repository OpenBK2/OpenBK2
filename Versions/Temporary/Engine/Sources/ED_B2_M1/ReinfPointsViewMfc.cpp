...
// The reinforcement points palette as it has always been: CReinfPointsWindow, a
// CResizeDialog over IDD_TAB_MI_REINF_POINTS with a three-column list, a player
// combo and four buttons.
//
...
namespace NReinfPointsView
{
	...
	{
		CReinfPointsWindow *pDialog =
				pTabWindow->AddNewTab( static_cast<CReinfPointsWindow*>( 0 ) );
		if ( pDialog == 0 )
		{
			return 0;
		}
		...
		pDialog->Create( CReinfPointsWindow::IDD, pTabWindow );
