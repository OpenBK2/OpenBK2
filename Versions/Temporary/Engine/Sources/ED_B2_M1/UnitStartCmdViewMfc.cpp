...
// The unit start commands palette as it has always been: CUnitStartCmdWindow, a
// CResizeDialog over IDD_TAB_MI_UNIT_START_CMD with a two-column list and four
// buttons.
//
...
namespace NUnitStartCmdView
{
	...
	{
		CUnitStartCmdWindow *pDialog =
				pTabWindow->AddNewTab( static_cast<CUnitStartCmdWindow*>( 0 ) );
		if ( pDialog == 0 )
		{
			return 0;
		}
		...
		pDialog->Create( CUnitStartCmdWindow::IDD, pTabWindow );
