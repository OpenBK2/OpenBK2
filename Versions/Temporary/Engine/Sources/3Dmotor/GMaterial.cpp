...
BASIC_REGISTER_CLASS( _3DMOTOR, IMaterial )
REGISTER_SAVELOAD_CLASS( _3DMOTOR, 0x02191161, CGenericMaterial )
REGISTER_SAVELOAD_CLASS( _3DMOTOR, 0x020A2170, CWaterMaterial )
REGISTER_SAVELOAD_CLASS( _3DMOTOR, 0x1314D3C0, CAnimWaterMaterial )
REGISTER_SAVELOAD_CLASS( _3DMOTOR, 0x1314E480, CSurfMaterial )
REGISTER_SAVELOAD_CLASS( _3DMOTOR, 0x004c2180, CTracksMaterial )
REGISTER_SAVELOAD_CLASS( _3DMOTOR, 0x200BE340, CTerrainMaterial )
REGISTER_SAVELOAD_CLASS( _3DMOTOR, 0x2014BAC1, CCloudsH5Material )
REGISTER_SAVELOAD_CLASS( _3DMOTOR, 0x131A9B00, CSimpleSkyMaterial )
REGISTER_SAVELOAD_CLASS( _3DMOTOR, 0x341C6B80, CReflectWaterMaterial )
