...
REGISTER_SAVELOAD_CLASS( _3DMOTOR, 0x0251100b, CGScene )
REGISTER_SAVELOAD_CLASS( _3DMOTOR, 0x03111000, CPolyline )
REGISTER_SAVELOAD_CLASS( _3DMOTOR, 0x00661130, CVolumeNode )
REGISTER_SAVELOAD_CLASS( _3DMOTOR, 0x11791170, CCombinedPart )
REGISTER_SAVELOAD_CLASS( _3DMOTOR, 0x27041130, CParticles )
REGISTER_SAVELOAD_CLASS( _3DMOTOR, 0x00372110, CGetTranspCache )
REGISTER_SAVELOAD_CLASS( _3DMOTOR, 0x00372140, CFakeParticleLMTexture )
REGISTER_SAVELOAD_CLASS( _3DMOTOR, 0x020a2190, CPostProcessBinder )
REGISTER_SAVELOAD_CLASS( _3DMOTOR, 0x01123131, CAmbientAnimator )
REGISTER_SAVELOAD_CLASS( _3DMOTOR, 0xB4409180, CSunFlares )
