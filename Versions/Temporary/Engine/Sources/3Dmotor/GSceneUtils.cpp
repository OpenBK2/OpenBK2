...
REGISTER_SAVELOAD_CLASS( _3DMOTOR, 0x02511005, CMSRNode )
REGISTER_SAVELOAD_CLASS( _3DMOTOR, 0x00821180, CMNode )
REGISTER_SAVELOAD_CLASS( _3DMOTOR, 0x0251100d, CCMSR )
REGISTER_SAVELOAD_CLASS( _3DMOTOR, 0xB0118000, CCVec2 )
REGISTER_SAVELOAD_CLASS( _3DMOTOR, 0x0251100e, CCVec3 )
REGISTER_SAVELOAD_CLASS( _3DMOTOR, 0x021a2150, CCVec4 )
REGISTER_SAVELOAD_CLASS( _3DMOTOR, 0x03031620, CCInt )
REGISTER_SAVELOAD_CLASS( _3DMOTOR, 0x0251100f, CCFloat )
REGISTER_SAVELOAD_CLASS( _3DMOTOR, 0x02831000, CCTRect )
REGISTER_SAVELOAD_CLASS( _3DMOTOR, 0x02831001, CCWString )
REGISTER_SAVELOAD_CLASS( _3DMOTOR, 0x02511010, CCFBTransform )
REGISTER_SAVELOAD_CLASS( _3DMOTOR, 0x02511011, CMSRConvert )
REGISTER_SAVELOAD_CLASS( _3DMOTOR, 0x02831151, CCRectLayout )
REGISTER_SAVELOAD_CLASS( _3DMOTOR, 0x02511012, CVec3Convert )
REGISTER_SAVELOAD_CLASS( _3DMOTOR, 0x02511013, CSinus )
REGISTER_SAVELOAD_CLASS( _3DMOTOR, 0x12341181, CScaleNode )
REGISTER_SAVELOAD_CLASS( _3DMOTOR, 0x114c1110, CCTPoint )
REGISTER_SAVELOAD_CLASS( _3DMOTOR, 0x022a2120, CExtractTranslation )
