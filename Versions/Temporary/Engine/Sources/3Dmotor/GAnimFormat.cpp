...
REGISTER_SAVELOAD_CLASS( _3DMOTOR, 0x13173BC2, CGrannyBaseStuffLoader )
REGISTER_SAVELOAD_CLASS( _3DMOTOR, 0x70683130, CGrannyAnimationLoader )
REGISTER_SAVELOAD_CLASS( _3DMOTOR, 0x70493150, CGrannyAIGeomLoader )
REGISTER_SAVELOAD_CLASS( _3DMOTOR, 0x100A2440, CGrannySkeletonLoader )
BASIC_REGISTER_CLASS( _3DMOTOR, CGrannyFileInfo )
