...
REGISTER_SAVELOAD_CLASS( _3DMOTOR, 0x201183C0, CLightmapTexture )
REGISTER_SAVELOAD_CLASS( _3DMOTOR, 0x20119C00, CLMGeometryGen )
BASIC_REGISTER_CLASS( _3DMOTOR, CLightmapTextureCache )
