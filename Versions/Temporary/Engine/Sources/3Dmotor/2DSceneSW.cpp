...
BASIC_REGISTER_CLASS( _3DMOTOR, ISWRects );
REGISTER_SAVELOAD_CLASS( _3DMOTOR, 0xF3005171, CSWRects )
REGISTER_SAVELOAD_CLASS( _3DMOTOR, 0xF3005172, CSW2DScene )
REGISTER_SAVELOAD_CLASS( _3DMOTOR, 0xF3005173, CSWSpot )
REGISTER_SAVELOAD_CLASS( _3DMOTOR, 0x20146400, C2DPostFilter )
REGISTER_SAVELOAD_CLASS( _3DMOTOR, 0x20172C80, CGrayingFilter )
