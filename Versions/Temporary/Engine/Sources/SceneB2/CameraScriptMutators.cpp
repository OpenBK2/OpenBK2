...
REGISTER_SAVELOAD_CLASS( SCENEB2, 0x1B1C84C0, CSCamDMoveFlightMutator )
REGISTER_SAVELOAD_CLASS( SCENEB2, 0x1B1C84C2, CSCamDFollowFlightMutator )
REGISTER_SAVELOAD_CLASS( SCENEB2, 0x1B1C84C3, CSCamDRotateFlightMutator )
REGISTER_SAVELOAD_CLASS( SCENEB2, 0x1B1C84C4, CSCamSplineMutator )
REGISTER_SAVELOAD_CLASS( SCENEB2, 0x1B224400, CScriptMoviesMutatorHolder )
