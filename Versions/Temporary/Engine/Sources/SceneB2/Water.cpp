...
REGISTER_SAVELOAD_CLASS( SCENEB2, 0x100BB400, CWaterPatchLayer );
REGISTER_SAVELOAD_CLASS( SCENEB2, 0x100BB401, CWaterPatch );
REGISTER_SAVELOAD_CLASS( SCENEB2, 0x100BB402, CWater );
