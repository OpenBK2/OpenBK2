...
void SECWorkspaceManagerEx::SetRegistryMode(const CString& strAppSubKey, BOOL bEnable, HKEY hKeyApp, BOOL bSectionKey) {
    spdlog::trace("{} this={} strAppSubKey={} bEnable={} hKeyApp={} bSectionKey={}", BOOST_CURRENT_FUNCTION, spdlog::fmt_lib::ptr(this),
...
void SECWorkspaceManagerEx::SetRegistryMode(BOOL bEnable, BOOL bSectionKey) {
    spdlog::trace("{} this={} bEnable={} bSectionKey={}", BOOST_CURRENT_FUNCTION, spdlog::fmt_lib::ptr(this), bEnable, bSectionKey);
}
...
BOOL SECWorkspaceManagerEx::SaveWorkspace(CString strWorkspaceName) {
    spdlog::trace("{} this={} strWorkspaceName={}", BOOST_CURRENT_FUNCTION, spdlog::fmt_lib::ptr(this), strWorkspaceName.GetString());
    return FALSE;
}

BOOL SECWorkspaceManagerEx::OpenWorkspace(BOOL bLastActiveWorkspace, BOOL bSuppressErrorDlg) {
    spdlog::trace("{} this={} bLastActiveWorkspace={} bSuppressErrorDlg={}", BOOST_CURRENT_FUNCTION, spdlog::fmt_lib::ptr(this), bLastActiveWorkspace, bSuppressErrorDlg);
    return FALSE;
}

BOOL SECWorkspaceManagerEx::OpenWorkspace(CString strWorkspaceName, BOOL bSuppressErrorDlg) {
    spdlog::trace("{} this={} strWorkspaceName={} bSuppressErrorDlg={}", BOOST_CURRENT_FUNCTION, spdlog::fmt_lib::ptr(this), strWorkspaceName.GetString(), bSuppressErrorDlg);
    return FALSE;
}
...
void SECWorkspaceManagerEx::SetMaxWorkspaceMRUSize(UINT nMaxSize) {
    spdlog::trace("{} this={} nMaxSize={}", BOOST_CURRENT_FUNCTION, spdlog::fmt_lib::ptr(this), nMaxSize);
}
...
void SECWorkspaceManagerEx::SetWorkspaceFileExtension(const CString& strExt) {
    spdlog::trace("{} this={} strExt={}", BOOST_CURRENT_FUNCTION, spdlog::fmt_lib::ptr(this), strExt.GetString());
}
...
SECPTNStrategy* SECWorkspaceManagerEx::GetPersistanceStrategy(const CString& strWorkspace) {
    spdlog::trace("{} this={} strWorkspace={}", BOOST_CURRENT_FUNCTION, spdlog::fmt_lib::ptr(this), strWorkspace.GetString());
    return nullptr;
}

BOOL SECWorkspaceManagerEx::OpenWorkspaceDockState(SECPersistentTreeNode* pRoot) {
    spdlog::trace("{} this={} pRoot={}", BOOST_CURRENT_FUNCTION, spdlog::fmt_lib::ptr(this), spdlog::fmt_lib::ptr(pRoot));
    return FALSE;
}

BOOL SECWorkspaceManagerEx::OpenWorkspaceFrameWnds(SECPersistentTreeNode* pRoot, CFrameWnd** ppActiveChildFrame) {
    spdlog::trace("{} this={} pRoot={} ppActiveChildFrame={}", BOOST_CURRENT_FUNCTION, spdlog::fmt_lib::ptr(this), spdlog::fmt_lib::ptr(pRoot), spdlog::fmt_lib::ptr(ppActiveChildFrame));
    return FALSE;
}
...
BOOL SECWorkspaceManagerEx::PromptWorkspaceName(CString& strWorkspaceName,BOOL bSaveAs) {
    spdlog::trace("{} this={} strWorkspaceName={} bSaveAs={}", BOOST_CURRENT_FUNCTION, spdlog::fmt_lib::ptr(this), strWorkspaceName.GetString(), bSaveAs);
    return FALSE;
}

void SECWorkspaceManagerEx::OpenWorkspaceCustomData(SECPersistentTreeNode* pRoot, const CString& strWorkspaceName) {
    spdlog::trace("{} this={} pRoot={} strWorkspaceName={}", BOOST_CURRENT_FUNCTION, spdlog::fmt_lib::ptr(this), spdlog::fmt_lib::ptr(pRoot), strWorkspaceName.GetString());
}
...
BOOL SECWorkspaceManagerEx::CloseControlBars(CPtrList* pListBars,CFrameWnd* pFrame) {
    spdlog::trace("{} this={} pListBars={} pFrame={}", BOOST_CURRENT_FUNCTION, spdlog::fmt_lib::ptr(this), spdlog::fmt_lib::ptr(pListBars), spdlog::fmt_lib::ptr(pFrame));
...
BOOL SECWorkspaceManagerEx::OpenAdditionalViewPerFrame(const CDocument* pDoc, const CFrameWnd* pFrame, const SECPersistentTreeNode* pAddViewNode) {
    spdlog::trace("{} this={} pDoc={} pFrame={} pAddViewNode={}", BOOST_CURRENT_FUNCTION, spdlog::fmt_lib::ptr(this), spdlog::fmt_lib::ptr(pDoc), spdlog::fmt_lib::ptr(pFrame), spdlog::fmt_lib::ptr(pAddViewNode));
    return FALSE;
}
SECPersistentTreeNode* SECWorkspaceManagerEx::SaveAdditionalViewPerFrame( CDocument* pDoc, CView* pView, CFrameWnd* pFrame, SECPTNFactory& nodeFactory, SECPersistentTreeNode* pParent, int nMultViewFrameUniqueID) {
    spdlog::trace("{} this={} pDoc={} pView={} pFrame={} pParent={} nMultViewFrameUniqueID={}", BOOST_CURRENT_FUNCTION, spdlog::fmt_lib::ptr(this), spdlog::fmt_lib::ptr(pDoc), spdlog::fmt_lib::ptr(pView), spdlog::fmt_lib::ptr(pFrame), spdlog::fmt_lib::ptr(pParent), nMultViewFrameUniqueID);
    return nullptr;
}
