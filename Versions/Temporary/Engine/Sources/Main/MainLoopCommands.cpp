...
REGISTER_SAVELOAD_CLASS( MAIN, 0x10075C09, CICExitGame );
REGISTER_SAVELOAD_CLASS( MAIN, 0x10075C0A, CICSave );
REGISTER_SAVELOAD_CLASS( MAIN, 0x10075C0B, CICLoad );
REGISTER_SAVELOAD_CLASS( MAIN, 0x170B7380, CICCloseInterface );
REGISTER_SAVELOAD_CLASS( MAIN, 0x17274380, CICFinalExitGame );
