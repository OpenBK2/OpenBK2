...
REGISTER_SAVELOAD_CLASS( UI, 0x11069C80, SWindowContextCommon );
REGISTER_SAVELOAD_CLASS( UI, 0x1109BC00, CUIFactory );
REGISTER_SAVELOAD_CLASS( UI, 0x110B5CC0, CVirtualScreenController );
