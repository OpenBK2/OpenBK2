...
BASIC_REGISTER_CLASS( UI, IML )
BASIC_REGISTER_CLASS( UI, IMLHandler )
REGISTER_SAVELOAD_CLASS( UI, 0xB0829160, CMLTextObject )
REGISTER_SAVELOAD_CLASS( UI, 0xB0829161, CMLImageObject )
REGISTER_SAVELOAD_CLASS( UI, 0xB0829162, CMLLayout )
REGISTER_SAVELOAD_CLASS( UI, 0xB0829163, CML )

REGISTER_SAVELOAD_CLASS( UI, 0xB1003230, CLEFTHandler )
REGISTER_SAVELOAD_CLASS( UI, 0xB1003231, CRIGHTHandler )
REGISTER_SAVELOAD_CLASS( UI, 0xB1003232, CCENTERHandler )
REGISTER_SAVELOAD_CLASS( UI, 0xB1003233, CJUSTIFYHandler )
REGISTER_SAVELOAD_CLASS( UI, 0xB1003234, CWRAPLEFTHandler )
REGISTER_SAVELOAD_CLASS( UI, 0xB1003235, CWRAPRIGHTHandler )
REGISTER_SAVELOAD_CLASS( UI, 0xB1003236, CTOPHandler )
REGISTER_SAVELOAD_CLASS( UI, 0xB1003237, CMIDDLEHandler )
REGISTER_SAVELOAD_CLASS( UI, 0xB1003238, CBOTTOMHandler )
REGISTER_SAVELOAD_CLASS( UI, 0xB1003239, CBRHandler )
REGISTER_SAVELOAD_CLASS( UI, 0xB100323A, CCOLORHandler )
REGISTER_SAVELOAD_CLASS( UI, 0xB100323B, CFONTHandler )
REGISTER_SAVELOAD_CLASS( UI, 0xB100323C, CIMAGEHandler )
REGISTER_SAVELOAD_CLASS( UI, 0x52353000, CNOWRAPHandler )
REGISTER_SAVELOAD_CLASS( UI, 0xB100323d, CMLStream )
REGISTER_SAVELOAD_CLASS( UI, 0xB3714190, CMINFONTSIZEHandler )
REGISTER_SAVELOAD_CLASS( UI, 0xB3716160, CMLTabObject )
REGISTER_SAVELOAD_CLASS( UI, 0xB3716161, CTABHandler )
REGISTER_SAVELOAD_CLASS( UI, 0xB3716162, CStateStack )
REGISTER_SAVELOAD_CLASS( UI, 0x30268440, SFadeValue )
