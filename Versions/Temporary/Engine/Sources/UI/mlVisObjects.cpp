...
using namespace NML;
REGISTER_SAVELOAD_CLASS( UI, 0xB5529200, CTextObject )
REGISTER_SAVELOAD_CLASS( UI, 0xB5529201, CImageObject )
REGISTER_SAVELOAD_CLASS( UI, 0xB5529202, CTabObject )
REGISTER_SAVELOAD_CLASS( UI, 0xB5529203, CSpringObject )
