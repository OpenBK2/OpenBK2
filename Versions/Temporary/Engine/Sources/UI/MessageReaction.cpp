...
REGISTER_SAVELOAD_CLASS(UI, 0x11075CC3, CMessageReactionB2)
REGISTER_SAVELOAD_CLASS(UI, 0x11075CC2, CARSendUIMessage)
REGISTER_SAVELOAD_CLASS(UI, 0x15083400, CARSendGameMessage)
REGISTER_SAVELOAD_CLASS(UI, 0x15084341, CARSiwtchTab)


BASIC_REGISTER_CLASS(UI, IMessageReactionB2);
