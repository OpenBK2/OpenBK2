...
using namespace NML;
REGISTER_SAVELOAD_CLASS( UI, 0xB5529190, CLineBreakObject )
REGISTER_SAVELOAD_CLASS( UI, 0xB5529191, CColorObject )
REGISTER_SAVELOAD_CLASS( UI, 0xB5529192, CHAlignObject )
REGISTER_SAVELOAD_CLASS( UI, 0xB5529193, CVAlignObject )
REGISTER_SAVELOAD_CLASS( UI, 0xB5529194, CFontObject )
REGISTER_SAVELOAD_CLASS( UI, 0xB5529195, CMinFontSizeObject )
