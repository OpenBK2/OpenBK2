...
float SConsts::dispersionRatio[10][2] =
{
	{ 1.0f,		1.0f },
	{ 1.0f,		2.0f },
	{ 1.0f,		3.0f },
...
START_REGISTER(AILogicConsts)
	...
	REGISTER_VAR_EX( "AI.Artillery.DispersionRatio.ATGMLineMin", NGlobal::VarFloatHandler, &SConsts::dispersionRatio[9][0], 1.0f, STORAGE_NONE );
