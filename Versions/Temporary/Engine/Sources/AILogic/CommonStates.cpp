...
REGISTER_SAVELOAD_CLASS( AILOGIC, 0x1108D4DE, CMechAttackUnitState );
REGISTER_SAVELOAD_CLASS( AILOGIC, 0x1108D4CF, CFollowState );
REGISTER_SAVELOAD_CLASS( AILOGIC, 0x1108D49E, CCommonSwarmState );
REGISTER_SAVELOAD_CLASS( AILOGIC, 0x1108D4AF, CCommonAmbushState );
REGISTER_SAVELOAD_CLASS( AILOGIC, 0x1508D482, CCommonMoveToGridState );
REGISTER_SAVELOAD_CLASS( AILOGIC, 0x1508D494, CMechUnitRestState );
REGISTER_SAVELOAD_CLASS( AILOGIC, 0x31130B80, CMoveByFormationState );
REGISTER_SAVELOAD_CLASS( AILOGIC, 0x1915DB80, CCommonPatrolState );
