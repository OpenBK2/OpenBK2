...
REGISTER_SAVELOAD_CLASS( AILOGIC, 0x1108D489, CPlaneStatesFactory );
REGISTER_SAVELOAD_CLASS( AILOGIC, 0x1108D48B, CPlaneBombState );
REGISTER_SAVELOAD_CLASS( AILOGIC, 0x1108D46B, CPlaneParaDropState );
REGISTER_SAVELOAD_CLASS( AILOGIC, 0x1108D46C, CPlaneFighterPatrolState );
REGISTER_SAVELOAD_CLASS( AILOGIC, 0x1108D46D, CPlaneShturmovikPatrolState );
REGISTER_SAVELOAD_CLASS( AILOGIC, 0x1108D46E, CPlaneLeaveState );
REGISTER_SAVELOAD_CLASS( AILOGIC, 0x1108D46F, CPlaneScoutState );
REGISTER_SAVELOAD_CLASS( AILOGIC, 0x1508D4A2, CPlaneFlyDeadState );
REGISTER_SAVELOAD_CLASS( AILOGIC, 0x110993C0, CPlaneRestState );
REGISTER_SAVELOAD_CLASS( AILOGIC, 0x11099400, CPlaneSwarmToState );
REGISTER_SAVELOAD_CLASS( AILOGIC, 0x3124CB40, CPlaneSuicideState );
