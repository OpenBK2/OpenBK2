...
void CSoldierMoveToState::Segment()
{
	...
	else
	{
		...
		if ( pUnit->IsIdle() || pUnit->GetNextCommand() != 0 && fabs2( pUnit->GetCenterPlain() - point ) <= sqr( 2.5f * (float)SConsts::TILE_SIZE ) )
		{
			...
			{
				const uint16_t wDir = pUnit->GetFrontDirection() == pUnit->GetDirection() ? uint16_t( wDirToPoint ) : wDirToPoint + 32768;
...
REGISTER_SAVELOAD_CLASS( AILOGIC, 0x1108D4E6, CSoldierFireMoraleShellState );
REGISTER_SAVELOAD_CLASS( AILOGIC, 0x1108D4AE, CSoldierAttackUnitInBuildingState );
REGISTER_SAVELOAD_CLASS( AILOGIC, 0x1108D49D, CSoldierAttackCommonStatObjState );
REGISTER_SAVELOAD_CLASS( AILOGIC, 0x1108D49C, CSoldierClearMineRadiusState );
REGISTER_SAVELOAD_CLASS( AILOGIC, 0x1108D49B, CSoldierPlaceMineNowState );
REGISTER_SAVELOAD_CLASS( AILOGIC, 0x1108D49A, CSoldierParadeState );
REGISTER_SAVELOAD_CLASS( AILOGIC, 0x1108D481, CSoldierStatesFactory );
REGISTER_SAVELOAD_CLASS( AILOGIC, 0x1108D465, CSoldierEnterTransportNowState );
REGISTER_SAVELOAD_CLASS( AILOGIC, 0x1108D466, CSoldierParaDroppingState );
REGISTER_SAVELOAD_CLASS( AILOGIC, 0x1108D467, CSoldierUseSpyglassState );
REGISTER_SAVELOAD_CLASS( AILOGIC, 0x1108D468, CSoldierAttackFormationState );
REGISTER_SAVELOAD_CLASS( AILOGIC, 0x1108D469, CSoldierIdleState );
REGISTER_SAVELOAD_CLASS( AILOGIC, 0x1108D46A, CSoldierAttackAviationState );
REGISTER_SAVELOAD_CLASS( AILOGIC, 0x1108D482, CSoldierRestState );
REGISTER_SAVELOAD_CLASS( AILOGIC, 0x1108D483, CSoldierAttackState );
REGISTER_SAVELOAD_CLASS( AILOGIC, 0x1108D484, CSoldierMoveToState );
REGISTER_SAVELOAD_CLASS( AILOGIC, 0x1108D485, CSoldierTurnToPointState );
REGISTER_SAVELOAD_CLASS( AILOGIC, 0x1108D486, CSoldierMoveByDirState );
REGISTER_SAVELOAD_CLASS( AILOGIC, 0x1108D487, CSoldierEnterState );
REGISTER_SAVELOAD_CLASS( AILOGIC, 0x1108D488, CSoldierEnterEntrenchmentState );
REGISTER_SAVELOAD_CLASS( AILOGIC, 0x1508D486, CSoldierUseState );
REGISTER_SAVELOAD_CLASS( AILOGIC, 0x110AB381, CSoldierEntrenchSelfState )
REGISTER_SAVELOAD_CLASS( AILOGIC, 0x110AB380, CSoldierLeaveSelfEntrenchState )
