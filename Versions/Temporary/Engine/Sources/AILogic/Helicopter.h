...
class CHelicopter : public CAviation
{
	...
	float fDeathGroundZ;
	float fDeathSpiralRadius;
	float fDeathSpiralSteps;
	float fDeathSpiralDownAcceleration;
