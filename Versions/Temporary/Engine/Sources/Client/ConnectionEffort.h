...
{
protected:
	void SendBreakThroughPacket( const std::string &szIP, const int nPort );
public:
...
namespace NEffortsFactory
{
	...
	void SetServerInfo( const std::string &szServerIP, const int nServerPort, const int nGameNetVersion );
}
