...
REGISTER_SAVELOAD_CLASS( GAMEX, MISSION_INTERFACE, CInterfaceMission );
REGISTER_SAVELOAD_CLASS_NM( GAMEX, 0x1009DCC2, CReactions, CInterfaceMission );
REGISTER_SAVELOAD_CLASS( GAMEX, ML_COMMAND_MISSION, CICMission )
REGISTER_SAVELOAD_CLASS( GAMEX, ML_COMMAND_LOAD_GAME, CICLoadB2 );
REGISTER_SAVELOAD_CLASS( GAMEX, ML_COMMAND_SAVE_GAME, CICSaveB2 );
