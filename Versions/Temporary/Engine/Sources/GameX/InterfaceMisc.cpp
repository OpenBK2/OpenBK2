...
REGISTER_SAVELOAD_CLASS( GAMEX, 0x170BE401, CInterfaceMessageBox )
REGISTER_SAVELOAD_CLASS( GAMEX, ML_COMMAND_MESSAGE_BOX, CICMessageBox )
REGISTER_SAVELOAD_CLASS( GAMEX, ML_COMMAND_PREVIOUS_MENU, CICPreviousMenu )
REGISTER_SAVELOAD_CLASS_NM( GAMEX, 0x170BE402, CReactions, CInterfaceMessageBox )
REGISTER_SAVELOAD_CLASS( GAMEX, ML_COMMAND_SUPPRESS_ENABLE_FOCUS, CICSuppressEnableFocus )
REGISTER_SAVELOAD_CLASS( GAMEX, ML_COMMAND_HIDE_UNFOCUSED_SCREEN, CICHideUnfocusedScreen )
REGISTER_SAVELOAD_CLASS( GAMEX, ML_COMMAND_HIDE_ALL_UP_TO, CICRemoveInterfacesUpTo )
REGISTER_SAVELOAD_CLASS( GAMEX, ML_COMMAND_CLEAR_INTERFACES, CICClearInterfaces )
